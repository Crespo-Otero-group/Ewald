...
The program is redistributed with explicit permission from the original authors as required by the Computer Physics Communications [license](http://cpc.cs.qub.ac.uk/licence/licence.html).
# Dependencies
